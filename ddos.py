...
More Safari 5.0.4 user agents strings -->>
...
More Safari 5.0.2 user agents strings -->>
...
More Safari 5.0 user agents strings -->>
...
More Safari 4.0.4 user agents strings -->>
...
More Safari 3.0.3 user agents strings -->>
